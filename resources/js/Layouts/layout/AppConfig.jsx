            ...
            >
                ...
                <div className="grid">
                    ...
                    <AppConfigButton
                        ...
                        onClick={() =>
                            _changeTheme("bootstrap4-light-purple", "light")
                        }
                    ></AppConfigButton>
                    <AppConfigButton
                    ...
                    <AppConfigButton
                        ...
                        onClick={() =>
                            _changeTheme("bootstrap4-dark-purple", "dark")
                        }
                    ></AppConfigButton>
                </div>
                ...
                <div className="grid">
                    ...
                    <AppConfigButton
                        ...
                        onClick={() =>
                            _changeTheme("md-light-deeppurple", "light")
                        }
                    ></AppConfigButton>
                    <AppConfigButton
                    ...
                    <AppConfigButton
                        ...
                        onClick={() =>
                            _changeTheme("md-dark-deeppurple", "dark")
                        }
                    ></AppConfigButton>
                </div>
                ...
                <div className="grid">
                    <AppConfigButton
                        ...
                        imgAlt="Material Light Indigo"
                        onClick={() =>
                            _changeTheme("mdc-light-indigo", "light")
                        }
                    />
                    <AppConfigButton
                        img="/images/layout/themes/md-light-deeppurple.svg"
                        ...
                        onClick={() =>
                            _changeTheme("mdc-light-deeppurple", "light")
                        }
                    />
                    <AppConfigButton
                        img="/images/layout/themes/md-dark-indigo.svg"
                    ...
                    <AppConfigButton
                        ...
                        onClick={() =>
                            _changeTheme("mdc-dark-deeppurple", "dark")
                        }
                    />
                </div>
